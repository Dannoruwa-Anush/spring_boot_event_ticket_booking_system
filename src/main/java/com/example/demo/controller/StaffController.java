...
public class StaffController {
    ...
    @GetMapping
    public ResponseEntity<PageResponseDTO<StaffResponseDTO>> getAllStaffMembers(Pageable pageable) {
        PageResponseDTO<StaffResponseDTO> response = service.getAllStaffMembers(pageable);
