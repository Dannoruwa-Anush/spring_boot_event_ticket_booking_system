...
public class RolePermissionServiceImpl implements RolePermissionService {
        ...
        public RolePermissionServiceImpl(RolePermissionRepository repository, RoleRepository roleRepository,
                        PermissionRepository permissionRepository, RolePermissionMapper mapper) {
        ...
        @Override
        @Transactional
        public List<RolePermissionResponseDTO> createRolePermissions(
                        RolePermissionRequestDTO dto) {
                ...
                List<RolePermission> savedRolePermissions = repository.saveAll(rolePermissions);

                logger.info(
                                "Permissions assigned successfully to role. Role ID: {}",
                                dto.getRoleId());

                return mapper.toResponseDTOList(savedRolePermissions);
        }
        ...
        public RolePermissionResponseDTO updateRolePermission(Long id, RolePermissionRequestDTO dto) {
                 ...
                 */
                boolean duplicateExists = repository.existsByRoleIdAndPermissionId(
                                dto.getRoleId(),
                                permissionId);

                boolean sameRelationship = rolePermission.getRole().getId().equals(dto.getRoleId())
